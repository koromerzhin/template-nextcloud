...
Feel free to check [issues page](https://github.com/koromerzhin/template-nextcloud/issues).
You can also take a look at the [contributing guide](
    https://github.com/koromerzhin/template-nextcloud/blob/develop/CONTRIBUTING.md
    ).
...
This project is [MIT](
    https://github.com/koromerzhin/template-nextcloud/blob/develop/LICENSE
    ) licensed.
